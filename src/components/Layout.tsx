...
import { LayoutDashboard, Plus, CheckSquare, BarChart3, Car, User, LogOut, Users, Building, TrendingUp, Briefcase, Megaphone, Tractor, PlaneTakeoff, HardDrive, MonitorSmartphone, BookUser } from 'lucide-react';
...
const useNavigationItems = () => {
  return useMemo(() => ({
    ...
    adminItems: [
      ...
      {
        path: '/revisao-clientes',
        icon: BookUser,
        label: 'Revisão de Clientes'
      }
    ]
  }), []);
};
