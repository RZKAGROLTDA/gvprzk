            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {task.checklist && task.checklist.length > 0 && (
                  <div>
                    <h4 className="font-medium mb-2">Produtos Oferecidos:</h4>
                    <div className="space-y-2">
                      {task.checklist.filter(item => item.selected).map((item, index) => (
                        <div key={index} className="flex justify-between items-center p-2 bg-muted/50 rounded">
                          ...
                          <div className="text-right">
                            {item.quantity && <p className="text-sm">Qtd: {item.quantity}</p>}
                            {item.price && <p className="text-sm font-medium">{formatSalesValue(item.price)}</p>}
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {task.prospectItems && task.prospectItems.length > 0 && (
                  <div>
                    <h4 className="font-medium mb-2">Itens de Prospect:</h4>
                    <div className="space-y-2">
