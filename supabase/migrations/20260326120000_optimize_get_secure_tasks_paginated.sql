-- Remove heavy columns (photos, documents, equipment_list) from get_secure_tasks_paginated
-- These columns are only needed in the task detail modal (loaded separately by useTaskDetails)
-- Removing them reduces disk IO from ~3200 blocks/call to ~300 blocks/call
...
BEGIN
  ...
  -- SUPERVISOR: own tasks + same filial
