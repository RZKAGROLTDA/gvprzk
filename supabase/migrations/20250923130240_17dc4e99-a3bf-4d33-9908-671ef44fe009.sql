-- Critical Security Fix: Secure Clients Table Access (Final)
...
DROP FUNCTION IF EXISTS public.get_secure_clients_enhanced();

-- 2. Create secure client data access function with proper masking
...
-- 3. Update clients table RLS policies to be more restrictive for contact data
...
-- 4. Create view for secure client access with masked data
