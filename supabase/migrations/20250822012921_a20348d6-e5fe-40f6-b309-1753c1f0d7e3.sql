-- Function to identify and clean duplicate tasks
...
BEGIN
  ...
  DELETE FROM products WHERE task_id = ANY(tasks_to_remove);
  
  -- Delete related reminders
  DELETE FROM reminders WHERE task_id = ANY(tasks_to_remove);
  
  -- Delete the duplicate tasks
  DELETE FROM tasks WHERE id = ANY(tasks_to_remove);
