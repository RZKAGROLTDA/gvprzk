DROP FUNCTION IF EXISTS public.search_client_equipment(text, text, text);
...
REVOKE EXECUTE ON FUNCTION public.search_client_equipment(text, text, text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.search_client_equipment(text, text, text) FROM anon;
