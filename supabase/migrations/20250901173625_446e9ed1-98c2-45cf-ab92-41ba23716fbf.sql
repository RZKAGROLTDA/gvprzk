-- Fix security definer view issue by dropping it and creating proper function instead
DROP VIEW IF EXISTS public.secure_clients_view;

-- Replace the problematic view with a secure function that doesn't use SECURITY DEFINER
...
-- Update the mask_sensitive_data function to not use SECURITY DEFINER
